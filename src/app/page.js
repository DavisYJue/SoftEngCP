...
export default function HomePage() {
  ...
  const { resetSelection, setDistrictFilter, setSuffixFilter, setFilterText } =
    useSelection();
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <p className="text-xl text-gray-500 max-w-xl mx-auto leading-relaxed mb-8">
            A curated thesaurus of Chinese road names, districts, and
            place-based terms—designed to enhance word segmentation and improve
